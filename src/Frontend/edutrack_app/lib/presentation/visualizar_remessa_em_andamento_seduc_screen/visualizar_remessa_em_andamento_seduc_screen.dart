...
class VisualizarRemessaEmAndamentoSeducScreen extends StatefulWidget {
  final Remessa? remessa;

  const VisualizarRemessaEmAndamentoSeducScreen({Key? key, this.remessa})
      : super(key: key);

  @override
  VisualizarRemessaEmAndamentoSeducScreenState createState() =>
      VisualizarRemessaEmAndamentoSeducScreenState();
}

class VisualizarRemessaEmAndamentoSeducScreenState
    extends State<VisualizarRemessaEmAndamentoSeducScreen>
  ...
  Widget _buildRastrear(BuildContext context) {
    return CustomElevatedButton(
        ...
        onPressed: () {
          onTapRastrear(context, widget.remessa);
        });
  }
  ...
  onTapRastrear(BuildContext context, Remessa? remessa) {
    if (remessa?.status_entrega == "Concluída") {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => TelaDeRastreioACaminhoEscolaOneScreen(),
        ),
      );
    } else {
      Navigator.pushNamed(
