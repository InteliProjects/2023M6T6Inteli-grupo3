...
class VisualizarRemessaEscolaTwoScreen extends StatelessWidget {
  VisualizarRemessaEscolaTwoScreen({Key? key}) : super(key: key);

  TextEditingController group270Controller = TextEditingController();
  ...
  /// Section Widget
  Widget _buildGroup270(BuildContext context) {
    return CustomTextFormField(
        controller: group270Controller, hintText: "Ex: Yuri carrega tudo");
  }

  /// Section Widget
  Widget _buildGroup271(BuildContext context) {
    return CustomTextFormField(
        controller: group271Controller, hintText: "Ex: Yuri carrega tudo");
  }

  /// Section Widget
  Widget _buildGroup269(BuildContext context) {
    return CustomTextFormField(
  ...
  /// Navigates to the telaDeRastreioEntregueEscolaScreen when the action is triggered.
  onTapRastrear(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.telaDeRastreioEntregueEscolaScreen);
  }
}
