import 'package:luis_s_application/presentation/perfil_transportadora_screen/widgets/perfiltransportadora_item_widget.dart';
...
class PerfilTransportadoraScreen extends StatelessWidget {
  PerfilTransportadoraScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildPerfilFornecedor(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return PerfilTransportadoraItemWidget();
      },
    );
  }
