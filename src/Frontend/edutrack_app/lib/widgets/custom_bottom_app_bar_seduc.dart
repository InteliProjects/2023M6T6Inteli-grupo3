...
class CustomBottomAppBarSeduc extends StatefulWidget {
  CustomBottomAppBarSeduc({this.onChanged});

  Function(BottomBarEnum)? onChanged;

  @override
  CustomBottomAppBarSeducState createState() => CustomBottomAppBarSeducState();
}

class CustomBottomAppBarSeducState extends State<CustomBottomAppBarSeduc> {
