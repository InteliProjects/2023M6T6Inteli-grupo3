...
class CustomBottomAppBarFornecedor extends StatefulWidget {
  CustomBottomAppBarFornecedor({this.onChanged});

  Function(BottomBarEnum)? onChanged;

  @override
  CustomBottomAppBarFornecedorState createState() => CustomBottomAppBarFornecedorState();
}

class CustomBottomAppBarFornecedorState extends State<CustomBottomAppBarFornecedor> {
